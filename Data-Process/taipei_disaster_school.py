...
# Init Data DB
table_name = 'taipei_disaster_school'

# Make CSV buffer and load into pandas DataFrame
buffer_csv = b'tick,hour_hand,minute_hand\n'


buffer_csv = io.BytesIO(buffer_csv) # io.BytesIO(b'') is a file-like object
...
clock_index = 'regions'
chart_query = (
    f"""(SELECT regions AS x_axis, 'hour' AS y_axis, hour_hand AS data
    FROM {table_name})
    UNION
